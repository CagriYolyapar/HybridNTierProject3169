...
namespace Project.COMMON.Tools
{
    ...
    {
        public static void Send(string receiver, string password = "Test1234.", string body = "Test mesajıdır", string subject = "Email Testi", string sender = "yzl3169Test@gmail.com")
        {
